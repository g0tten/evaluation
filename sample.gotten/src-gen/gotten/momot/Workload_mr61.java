...
public class Workload_mr61 {
  protected final static String INITIAL_MODEL = "model/initial/workloads/workload_00002/workload_00002.xmi";
  
  protected final static int SOLUTION_LENGTH = 50;
  
  protected final String[] modules = new String[] { "model/workload_mr6.henshin" };
  ...
  protected double _createObjectiveHelper_0(final TransformationSolution solution, final EGraph graph, final EObject root) {
    return FitnessFunctionForWorkload_mr6.getWOrkloadDistance(((WorkloadSet) root), Workload_mr61.INITIAL_MODEL);
  }
  ...
  protected SearchAnalyzer performAnalysis(final SearchExperiment<TransformationSolution> experiment) {
    ...
    System.out.println("---------------------------");
    try {
    	System.out.println("- Save Analysis to 'output/workload_00002/mr6/analysis/analysis.txt'");
    	searchAnalyzer.saveAnalysis(new File("output/workload_00002/mr6/analysis/analysis.txt"));
    } catch(IOException e) {
    	e.printStackTrace();
    }
    System.out.println("- Save Indicator BoxPlots to 'output/workload_00002/mr6/analysis/'");
    searchAnalyzer.saveIndicatorBoxPlots(
    	"output/workload_00002/mr6/analysis/",
    	baseName
    );
  ...
  protected TransformationResultManager handleResults(final SearchExperiment<TransformationSolution> experiment) {
    ...
    System.out.println("- Save objectives of all algorithms to 'output/workload_00002/mr6/objectives/objective_values.txt'");
    TransformationResultManager.saveObjectives(
    	"output/workload_00002/mr6/objectives/objective_values.txt",
    	population
    );
    System.out.println("---------------------------");
    ...
    population = 
    	TransformationResultManager.createApproximationSet(experiment, (String[])null);
    System.out.println("- Save solutions of all algorithms to 'output/workload_00002/mr6/solutions/objective_values.txt'");
    TransformationResultManager.savePopulation(
    	"output/workload_00002/mr6/solutions/objective_values.txt",
    	population,
    	populationWriter
    );
    System.out.println("- Save solutions of all algorithms to 'output/workload_00002/mr6/solutions/objective_values.txt'");
    TransformationResultManager.saveSolutions(
    	"output/workload_00002/mr6/solutions/",
    	baseName,
    ...
    population = 
    	TransformationResultManager.createApproximationSet(experiment, (String[])null);
    System.out.println("- Save models of all algorithms to 'output/workload_00002/mr6/models/'");
    TransformationResultManager.saveModels(
    	"output/workload_00002/mr6/models/",
    	baseName,
    	population
    );
  ...
  public static void initialization() {
    ...
    IOUtils.deleteFolder("C:/eclipse/runtime-EclipseApplication2/sample.gotten/output/workload_00002/mr6/models");
  ...
  public static void finalization() {
    ...
    FollowUpUtils.copyModels("C:/eclipse/runtime-EclipseApplication2/sample.gotten/output/workload_00002/mr6/models", "C:/eclipse/runtime-EclipseApplication2/sample.gotten/model/workloads/workload_00002/mr6");
    System.out.println("Copy finished.");
  }
  
  public static void main(final String... args) {
    initialization();
    Workload_mr61 search = new Workload_mr61();
