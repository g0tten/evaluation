...
public class Workload_mr60 {
  protected final static String INITIAL_MODEL = "model/initial/workloads/workload_00001/workload_00001.xmi";
  ...
  protected double _createObjectiveHelper_0(final TransformationSolution solution, final EGraph graph, final EObject root) {
    return FitnessFunctionForWorkload_mr6.getWOrkloadDistance(((WorkloadSet) root), Workload_mr60.INITIAL_MODEL);
  }
  ...
  protected SearchAnalyzer performAnalysis(final SearchExperiment<TransformationSolution> experiment) {
    ...
    System.out.println("---------------------------");
    try {
    	System.out.println("- Save Analysis to 'output/workload_00001/mr6/analysis/analysis.txt'");
    	searchAnalyzer.saveAnalysis(new File("output/workload_00001/mr6/analysis/analysis.txt"));
    } catch(IOException e) {
    	e.printStackTrace();
    }
    System.out.println("- Save Indicator BoxPlots to 'output/workload_00001/mr6/analysis/'");
    searchAnalyzer.saveIndicatorBoxPlots(
    	"output/workload_00001/mr6/analysis/",
    	baseName
    );
  ...
  protected TransformationResultManager handleResults(final SearchExperiment<TransformationSolution> experiment) {
    ...
    System.out.println("- Save objectives of all algorithms to 'output/workload_00001/mr6/objectives/objective_values.txt'");
    TransformationResultManager.saveObjectives(
    	"output/workload_00001/mr6/objectives/objective_values.txt",
    	population
    );
    System.out.println("---------------------------");
    ...
    population = 
    	TransformationResultManager.createApproximationSet(experiment, (String[])null);
    System.out.println("- Save solutions of all algorithms to 'output/workload_00001/mr6/solutions/objective_values.txt'");
    TransformationResultManager.savePopulation(
    	"output/workload_00001/mr6/solutions/objective_values.txt",
    	population,
    	populationWriter
    );
    System.out.println("- Save solutions of all algorithms to 'output/workload_00001/mr6/solutions/objective_values.txt'");
    TransformationResultManager.saveSolutions(
    	"output/workload_00001/mr6/solutions/",
    	baseName,
    ...
    population = 
    	TransformationResultManager.createApproximationSet(experiment, (String[])null);
    System.out.println("- Save models of all algorithms to 'output/workload_00001/mr6/models/'");
    TransformationResultManager.saveModels(
    	"output/workload_00001/mr6/models/",
    	baseName,
    	population
    );
  ...
  public static void main(final String... args) {
    initialization();
    Workload_mr60 search = new Workload_mr60();
